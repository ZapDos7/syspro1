...
Validator results:
- Passes all tests minus the ones on top-k commands (yields proper results but leads to FAIL, while, when executed without the script, the results are correct.)
